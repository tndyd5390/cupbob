				...
				<form class="form-horizontal">
					...
					<div class="col-lg-7">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="김치 컵밥" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="3000원" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="250" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="김치(국내산), 쌀(국내산), 계란(국내산)" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
