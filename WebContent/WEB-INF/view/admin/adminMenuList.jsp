			...
			$.ajax({
				...
				success : function(data) {
					...
					$.each(data, function(key, value) {
						contents += "<tr>";
						contents += "<td><input type='checkbox' name='del_check' id='inlineCheckbox1' value='"+value.prdt_no+"'"+">";
						contents += "<td>"+value.prdt_no+"</td>";
	...
	<form action="adminMenuCheckedDelete.do" method="post" id="f" onsubmit="return false;">
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">
					<i class="icon_document_alt"></i>메뉴 관리
				</h3>
				<ol class="breadcrumb">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				메뉴 목록 <from class="navbar-form pull-right"> 메뉴 검색 : <input
					class="form-control" placeholder="Search" type="text"
					id="menuSearch"> </from> </header>
				<div class="table-responsive">
					<form action=adminMenuCheckedDelete.do method="post" id="f">
						<table class="table" align="center">
							<thead>
								<tr>
									<th><input type="checkbox" name="all" id="inlineCheckbox1"
							...
							<tbody id="menuList">
								...
								<tr>
									<td><input type="checkbox" name="del_check"
										id="inlineCheckbox1"
										value="<%=CmmUtil.nvl(pDTO.getPrdt_no())%>"></td>
									<td><%=pDTO.getPrdt_no()%></td>
									<td><a
										href="adminMenuDetail.do?pnum=<%=pDTO.getPrdt_no()%>"><%=pDTO.getPrdt_name()%></a></td>
					...
					<div style="float: right">
						...
						<a class="btn btn-default" title="클릭하시면 선택된것들이 삭제됩니다." href="#" onclick="menuDel_check();">삭제</a>
					</div>
				</div>
				</section>
			</div>
