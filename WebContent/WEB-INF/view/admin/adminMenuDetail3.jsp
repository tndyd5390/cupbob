	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal">
					...
					<div class="col-lg-7">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="숙주 컵밥" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="3300원" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="300" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input id="cp1" type="text" value="숙주(국내산), 쌀(국내산), 가쓰오부시(일본산), 베이컨(호주산)" size="16"
									class="form-control">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<div class="input-append date" id="dpYears"
									data-date="18-06-2017" data-date-format="dd-mm-yyyy"
				...
				<a class="btn btn-info" href="#" title="클릭하시면 삭제됩니다.">삭제</a>
						</span>
					</div>
				</form>
			</div>
